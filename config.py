...
# ----- ระบบเสียงแจ้งเตือน -----
SOUND_ENABLED = True               # เปิด/ปิดเสียงแจ้งเตือนตอนสแกน

# ----- เกณฑ์คุณภาพใบหน้า (Face Quality Assessment) -----
# กรองใบหน้าคุณภาพต่ำออกก่อนจะนำไปจดจำ ช่วยลด false positive
MIN_FACE_SIZE = 80                  # ขนาดใบหน้าขั้นต่ำ (pixels) ใบหน้าที่เล็กกว่านี้จะถูกข้าม
MIN_DET_SCORE = 0.5                 # คะแนนความมั่นใจขั้นต่ำจาก face detector (0.0-1.0)
MIN_BLUR_THRESHOLD = 50.0           # เกณฑ์ Laplacian variance ขั้นต่ำ (ยิ่งสูงยิ่งคมชัด ต่ำกว่านี้=เบลอ)
MIN_BRIGHTNESS = 40                 # ค่าความสว่างเฉลี่ยขั้นต่ำ (0-255) ต่ำกว่านี้=มืดเกินไป
MAX_BRIGHTNESS = 220                # ค่าความสว่างเฉลี่ยสูงสุด (0-255) สูงกว่านี้=สว่างเกินไป

# ----- การจัดการหน่วยความจำ -----
CHECKIN_HISTORY_TTL_SEC = 3600      # อายุข้อมูลคูลดาวน์ในหน่วยความจำ (วินาที) เก่ากว่านี้จะถูกเคลียร์
